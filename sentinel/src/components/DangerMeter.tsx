  ...
  return (
    <view className="card">
      ...
      {score?.reasons?.length ? (
        ...
        <text className="small muted" style={{ marginTop: 8 }}>Run a scan to see risk drivers.</text>
      )}
    </view>
  )
}
